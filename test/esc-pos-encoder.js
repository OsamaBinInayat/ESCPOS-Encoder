...
describe('EscPosEncoder', function() {
    ...
    describe('qrcode(https://smsami.com/)', function () {
        let result = encoder.qrcode('https://smsami.com/').encode();
    ...
    describe('qrcode(https://smsami.com/, 1, 8, h)', function () {
        let result = encoder.qrcode('https://smsami.com/', 1, 8, 'h').encode();
    ...
    describe('image(canvas, 8, 8) - with a black pixel at 0,0 (legacy)', function () {
        ...
        // Load the image
        loadImage('https://res.cloudinary.com/pos-prod/image/upload/c_fill,g_face,w_240,h_160/v1614238592/pos-prod/spk2awsouyyhcudfhtqd.png').then((image) => {
        ...
        let result = rasterEncoder.image(canvas, canvas.width, canvas.height).encode();
        ...
        console.log("Raster Image: " + base64String);
